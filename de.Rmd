...
```
<div class="caption">
`r caption` Daten auf github: <a href="https://github.com/snsf-data/datastory_women_underrepresented_or_underfunded/data" target="_blank">Erfolgs- und Förderquoten in der Projektförderung</a>.
</div>
</div>
